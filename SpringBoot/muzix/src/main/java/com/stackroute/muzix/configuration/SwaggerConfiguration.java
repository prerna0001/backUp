...
public class SwaggerConfiguration {
    ...
    private ApiInfo appInfo(){
        ApiInfo apiInfo = new ApiInfo("Muzix API(playmusic)","Spring boot Application for sound tracks","1.0","Terms Of Service",new Contact("Rutuja","http://yahoo.com","shenbaga30may@gmail.com"),"Apache License Version 2.0","https://www.apache.org/license.html");
        return apiInfo;
    }
}
